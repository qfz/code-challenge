...
export type EnergyAccounts = typeof accounts;
export type EnergyAccount = EnergyAccounts[number];

export function MOCK_ENERGY_ACCOUNTS_API(): Promise<EnergyAccounts> {
